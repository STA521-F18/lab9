...
#   lambda.beta = 3.06
  ...
  # transform intercept to original units (uncentered)
...
```{r}
library(MASS)
college.ridge = lm.ridge(log(Apps) ~ ., data=College, lambda=seq(0, 10, length=50))
